---
name: sts2-combat
description: Use this for normal Slay the Spire 2 combat planning and turn execution. Trigger it before taking combat turns, when a fight presents setup vs tempo tension, when cost changes or free-card effects appear, and whenever you need general combat heuristics that are not boss-or-elite specific.
---
...
- `/home/igorw/Work/STS2/vault/strategy/combat-heuristics.md`
- the current run log under `/home/igorw/Work/STS2/vault/runs`

If the run is Ironclad, also read:

- `/home/igorw/Work/STS2/.agents/skills/sts2-ironclad/SKILL.md`
...
Keep this skill short. Move durable lessons into the vault, then refine this workflow when repeated combat mistakes or better patterns appear.
