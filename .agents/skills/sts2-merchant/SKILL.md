---
name: sts2-merchant
description: Use this when the current Slay the Spire 2 screen is a merchant or when planning a shop line from map pressure, gold, deck state, relics, and potions. Trigger it before buying, before leaving a shop, and when a forced elite or boss makes the shop an immediate survival checkpoint.
---
...
Keep this skill short and practical. Move durable shopping heuristics into the vault, then tighten this workflow when better shop patterns are discovered.
